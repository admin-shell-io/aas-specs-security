...
* PKI X.509 identities (ITU-T Recommendation X.509 (2005) xref:bibliography.adoc#bib1[[10\]]).
* Decentralized Identifiers (DID) and Verifiable Credentials (VC) (Decentralized Identifiers (DIDs) v1.0 xref:bibliography.adoc#bib1[[11\]]).
...
Structuring of AAS information is described in @todo IDTA 01001 xref:bibliography.adoc#bib1[[1\]]. AAS, Submodels, and SubmodelElements should be structured in a way that reflects different security levels applying to individual information offered by the respective substructure, e.g., by confining sensitive information into separate Submodels or SubmodelElements.
...
====
Note: Versioning of AAS information is described in @todo IDTA 01001 xref:bibliography.adoc#bib1[[1\]]. Versioning information can be used by the AAS user application to decide whether the data is still reliable and to detect data inconsistencies which may have occurred due to an attack (e.g., lost updates).
====
...
====
Note: Versioning of AAS information is described in @todo IDTA 01001 xref:bibliography.adoc#bib1[[1\]].
====
