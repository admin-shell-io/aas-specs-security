...
Identification and authentication of AAS user applications and AAS interface provides a basis for integrity protection (xref:security-objectives.adoc#_integrity[Integrity]) and confidentiality protection (xref:security-objectives.adoc#_confidentiality[Confidentiality]) for data represented by the AAS exchanged via the AAS interface.
...
* Data in transit protection, i.e., ensure authenticity of source and recipient (xref:security-objectives.adoc#_integrity[Integrity], <<_identification_and_authentication_of_aas_user_applications_and_aas_interface>>) and protect integrity of information delivered via the AAS interface while in transit to the AAS user application.
