...
====
Note: This requirement does not affect the situation where data represented by the AAS is intentionally configured to be visible or invisible for AAS user application users depending on their privilege level (@todo 5.2.3.1, @todo 6.2).
====
