...
The security requirements for confidentiality, integrity, and availability are specified in xref:protection-goals.adoc[Protection Goals].
...
The normative requirements are specified in xref:requirements.adoc[Requirements].
