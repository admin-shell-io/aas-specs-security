...
Identifiables (i.e. Asset Adminstration Shells, Submodels and Concept descriptions) can also be signed by the additional endpoint /$signed, as described in the REST API specification.
...
Clause xref:accountability.adoc[] describes accountability for AAS content and digital signatures

Clause xref:asset_binding.adoc[] describes secure asset binding
