...
For AASQL and the Security part of this specification, DateTime and Time values are interpreted according to RFC 3339. This is more specific and more detailed than the generic XSD matching concepts MatchesXsTime and MatchesXsDateTime, which are less explicit about the lexical form of the values.
...
These literal patterns are aligned with the RFC 3339-based interpretation used for AASQL and the Security part of this specification.
