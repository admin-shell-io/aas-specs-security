...
These verification functions are based on the XML Schema `xs:dateTime` lexical representation defined in https://www.w3.org/TR/xmlschema-2/#dateTime[] and the ISO 8601 formats referenced by XML Schema in https://www.w3.org/TR/xmlschema-2/#isoformats[].
