...
<<image-i40-service-model>> gives an overview of the Access Rule Model.
...
In addition to the text below, the further details of the formula expressions are explained in  link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01002/v3.1/general.html#query-language[IDTA-01002, Query Language] .

[plantuml,image-i40-service-model,svg]
....
...
link:https://admin-shell-io.github.io/aas-specs-antora/IDTA-01002/v3.1/general.html#query-language[Version 3.1 of the AAS API] defines queries and uses the same grammar and same JSON schema to define queries.
