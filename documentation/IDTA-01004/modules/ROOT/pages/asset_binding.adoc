...
This association is unprotected and is subject to attack on the side of the AAS as well as on the side of the asset (e.g., tampered data carrier). IEEE 802.1AR specifies Secure Device Identities designed to be used as interoperable secure device authentication credentials.
