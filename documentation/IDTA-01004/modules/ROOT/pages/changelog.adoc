...
* Clarified the FORMULA evaluation context for CREATE and UPDATE operations, including evaluation of both the current and prospective state for UPDATE [#98](https://github.com/admin-shell-io/aas-specs-security/issues/98).
