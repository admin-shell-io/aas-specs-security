...
* changed: Time literals in access rules now follow JSON Schema `format: "time"` / RFC 3339 full-time semantics. Time values require seconds and a timezone offset, e.g. `09:00:00Z`; shorthand values such as `09:00` are no longer valid. [#63](https://github.com/admin-shell-io/aas-specs-security/issues/63)
